...
import PatientChart from "../../components/Dashboard/Admin_Dashboard/PaitentChart";
import DonutChart from "../../components/Dashboard/Admin_Dashboard/DonutChart";
              ...
              <div className="row">
                <div className="col-md-6">
                  <div className="morning-user">
                    <h2>
                      Good Morning, <span>Admin yo</span>
                    </h2>
