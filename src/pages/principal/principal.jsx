...
import MarketAreaChart from "../../components/Dashboard/Doctor_Dashboard/IncomeChart";
import RadialPatientsChart from "../../components/Dashboard/Doctor_Dashboard/DonutChart";
import ActivityChart from "../../components/Dashboard/Doctor_Dashboard/ActivityChart";
import RadialBarChart from "../../components/Dashboard/Patient_Dashboard/FullChart";
              ...
              <div className="row">
                <div className="col-md-6">
                  <div className="morning-user">
                    <h2>
                      Buenas tardes <span>Director</span>
                    </h2>
